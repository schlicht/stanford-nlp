...
def pad_sents_char(sents, char_pad_token):
    ...
    for sent in sents:
        ...
        for i, word in enumerate(sent):
            word_trunc = word[:max_word_length] if len(word) > max_word_length else word
            word_trunc = word_trunc + [char_pad_token] * (max_word_length - len(word_trunc))
            word_padded.append(word_trunc)
        sents_padded.append(word_padded + [word_placeholder] * (max_sentence_length - len(word_padded)))
    ### END YOUR CODE
